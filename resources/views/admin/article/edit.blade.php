            ...
            <table class="add_tab">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <img src="/{{$art_info->art_thumb}}" alt="" id="art_thumb_img" style="max-width: 350px; max-height: 100px" >
                        </td>
                    </tr>
                    <tr>
                        <th>关键词：</th>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <script id="editor" name="art_content" type="text/plain" style="width:800px;height:500px;">{!!$art_info->art_content!!}</script>
                            <script type="text/javascript">
