            ...
            <table class="add_tab">
                <tbody>
                    ...
                    <tr>
                        <th>配置项类型：</th>
                        <td>
                            <input type="radio" name="field_type" value="input" @if($edit->field_type == 'input') checked @endif onclick="showTr()">input　
                            <input type="radio" name="field_type" value="textarea" @if($edit->field_type == 'textarea') checked @endif onclick="showTr()">textarea　
                            <input type="radio" name="field_type" value="radio" @if($edit->field_type == 'radio') checked @endif onclick="showTr()">radio　
                        </td>
                    </tr>
