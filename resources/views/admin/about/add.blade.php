        ...
        <form action="{{url('admin/about')}}" method="post">
            ...
            <table class="add_tab">
                ...
                <tr>
                    <th>姓名：</th>
                    <td>
                        <input type="text" name="about_name">
                    </td>
                </tr>
                <tr>
                    <th>省份：</th>
                    <td>
                        <input type="text" name="about_region">
                    </td>
                </tr>
                <tr>
                    <th>个人简介：</th>
                    <td>
                        <input type="text" class="lg" name="about_description">
                    </td>
                </tr>
                <tr>
                    <th>个性签名：</th>
                    <td>
                        <input type="text" class="lg" name="about_autograph">
                    </td>
                </tr>
                <tr>
                    <th>头像：</th>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="lg" name="about_title">
                    </td>
                </tr>
                <tr>
                    <th>关于我内容：</th>
